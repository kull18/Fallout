  ...
  characters: Character[] = [
    {
      ...
      description: 'Protagonista del primer juego, un sobreviviente que emerge de una bóveda para buscar agua potable y termina convirtiéndose en un héroe o villano, según las decisiones del jugador y que hacen que el universo fallout cobre coherencia a lo largo que el jugador avanza',
    },
    {
      image: 'FO01_NPC_Tandi_N.webp',
      name: 'Tandy',
      description: 'Tandy es un personaje clave en Fallout 2, conocida por ser la líder de Arroyo y la hija del protagonista del primer juego. Con una personalidad carismática y decidida',
    },
    {
  ...
  events: Event[] = [
    {
      ...
      extraDescription: 'hola aewwwwwwwwwwwwwwww'
    },
    {
      image: '1720972-ncr_flag.png',
      name: 'La creación de la RNC',
      description: 'La República Nueva de California (RNC) se formó en el año 2186 como respuesta a la creciente anarquía y la falta de orden en la postguerra de la Costa Oeste. Su creación fue impulsada',
      extraDescription: 'que'
    },
    {
      image: 'fallout76_nuke.webp',
      name: 'La caída de las bombas',
      description: 'La caída de las bombas en Fallout ocurrió el 23 de octubre de 2077, un evento catastrófico que resultó en la destrucción masiva de la civilización',
      extraDescription: 'aw'
    }
  ];
